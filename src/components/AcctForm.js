      ...
      <div className="login-page-new__main-container">
        <div className="login-page-new__main-form">
          ...
          <div className="signup_page_new_inserted">
            <form className="signup_form_" onSubmit={handleSubmit}>
                ...
                <div className="cu-form__row">
                  ...
                  {err && fullname === "" ? (
                    <p className="cu-form__error">
                      ...
                      <span class="cu-form__error-text">
                        {" "}
                        Full name required!{" "}
                      </span>
                    </p>
              ...
              {showPasswordInput && (
                <div className="cu-form__row">
                  ...
                  {showpassword && (
                    ...
                    >
                      <Link>{isPasswordVisible ? "Hide" : "Show"}</Link>
                    </div>
                  )}
              ...
              <div className="cu-form__row cu-form__row_last">
                <button
                  type="submit"
                  className="login_page_new__main_form_button"
                >
          ...
          <a
            href="#"
            target="_blank"
            className="login-page-new__main-form-help"
          >
            <svg
              fill="none"
        ...
        {botTeamsText && (
          <div className="login-page-new__main-bot-teams">
            {" "}
        ...
        {dontHaveAcct && (
          <div className="login-page-new__main-bot">
            <div className="login-page-new__main-bot-text">
              {" "}
              Don't have an account?
              <Link className="login-page-new__main-bot-text-link" to="/">
                {" "}
                Sign up
              </Link>
            </div>
        ...
        {recaptcha && (
          <div className="login-page-new__main-footerr">
            ...
            <a
              href="#"
              target="_blank"
              className="login-page-new__main-footer-link"
            >
              {" "}
              Privacy Policy{" "}
            </a>
